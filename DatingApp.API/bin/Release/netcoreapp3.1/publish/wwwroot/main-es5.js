...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppListsListsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<p>lists works!</p>\n";
    /***/
  },
    ...
    function () {
      ...
      _createClass(MemberListComponent, [{
        ...
        value: function loadUsers() {
          ...
          this.userService.getUsers(this.userParams).subscribe(function (user) {
            _this3.users = user;
          }, function (error) {
  ...
  function srcAppMembersPhotoEditorPhotoEditorComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(PhotoEditorComponent, [{
        ...
        value: function initializeUploader() {
          ...
          this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
              var res = JSON.parse(response); // Converting String into an object
              ...
              _this4.photos.push(photo);

              if (photo.isMain) {
                _this4.authService.updateNavUserPhoto(photo.url);

                _this4.authService.currentUser.photoUrl = photo.url;
                localStorage.setItem('user', JSON.stringify(_this4.authService.currentUser));
              }
            }
          };
        }
        ...
        value: function setMainPhoto(photo) {
          ...
          this.userService.setMainPhoto(this.authService.decodedToken.nameid, photo.id).subscribe(function () {
            _this5.currentMainPhoto = _this5.photos.filter(function (p) {
              return p.isMain === true;
            })[0];
            _this5.currentMainPhoto.isMain = false;
            photo.isMain = true;

            _this5.authService.updateNavUserPhoto(photo.url);

            _this5.authService.currentUser.photoUrl = photo.url;
            localStorage.setItem('user', JSON.stringify(_this5.authService.currentUser));
          }, function (error) {
        ...
        value: function deletePhoto(id) {
          ...
          this.alertify.confirm('Are you sure want to delete this photo?', function () {
            _this6.userService.deletePhoto(_this6.authService.decodedToken.nameid, id).subscribe(function () {
              _this6.photos.splice(_this6.photos.findIndex(function (p) {
                return p.id === id;
              }), 1);

              _this6.alertify.success('Photo has been deleted');
            }, function (error) {
              _this6.alertify.error('Failed to delete the photo');
            });
          });
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()], PhotoEditorComponent.prototype, "mainPhotoChangeImmediate", void 0);
      ...
      _createClass(MemberDetailResolver, [{
        ...
        value: function resolve(route) {
          ...
          return this.userService.getUser(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
            _this7.alertify.error('Problem retrieving the data');

            _this7.router.navigate(['/discover']);
      ...
      _createClass(MemberEditResolver, [{
        ...
        value: function resolve(route) {
          ...
          return this.userService.getUser(this.authService.decodedToken.nameid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
            _this8.alertify.error('Problem retrieving your data');

            _this8.router.navigate(['/discover']);
      ...
      _createClass(MemberListResolver, [{
        ...
        value: function resolve(route) {
          ...
          return this.userService.getUsers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["catchError"])(function (error) {
            _this9.alertify.error('Problem retrieving the data');
  ...
  function srcApp_servicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AuthService, [{
        key: "updateNavUserPhoto",
        value: function updateNavUserPhoto(photoUrl) {
        ...
        value: function login(model) {
          ...
          return this.http.post(this.baseUrl + 'login', model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (response) {
            ...
            if (user) {
              ...
              _this10.updateNavUserPhoto(_this10.currentUser.photoUrl);
            }
  ...
  function srcApp_servicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UserService, [{
        key: "getUsers",
        value: function getUsers(userParams) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_error_interceptor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    ...
    var _lists_lists_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./lists/lists.component */
    "./src/app/lists/lists.component.ts");
    /* harmony import */


    var _messages_messages_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    ...
    var _services_user_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./_services/user.service */
    "./src/app/_services/user.service.ts");
    /* harmony import */
    ...
    var _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./_resolver/member-detail-resolver */
    "./src/app/_resolver/member-detail-resolver.ts");
    /* harmony import */


    var _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    ...
    var _resolver_member_edit_resolver__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    ...
    var time_ago_pipe__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! time-ago-pipe */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_11__["AppComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_12__["NavbarComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_16__["HomeComponent"], _register_register_component__WEBPACK_IMPORTED_MODULE_17__["RegisterComponent"], _Members_member_list_member_list_component__WEBPACK_IMPORTED_MODULE_18__["MemberListComponent"], _lists_lists_component__WEBPACK_IMPORTED_MODULE_19__["ListsComponent"], _messages_messages_component__WEBPACK_IMPORTED_MODULE_20__["MessagesComponent"], _Members_member_card_member_card_component__WEBPACK_IMPORTED_MODULE_24__["MemberCardComponent"], _Members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_25__["MemberDetailComponent"], _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_28__["MemberEditComponent"], _Members_photo_editor_photo_editor_component__WEBPACK_IMPORTED_MODULE_31__["PhotoEditorComponent"], time_ago_pipe__WEBPACK_IMPORTED_MODULE_32__["TimeAgoPipe"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["BsDropdownModule"].forRoot(), ngx_bootstrap__WEBPACK_IMPORTED_MODULE_5__["TabsModule"].forRoot(), _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_7__["RouterModule"].forRoot(_routes__WEBPACK_IMPORTED_MODULE_21__["appRoutes"]), ngx_gallery__WEBPACK_IMPORTED_MODULE_8__["NgxGalleryModule"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_10__["FileUploadModule"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_9__["JwtModule"].forRoot({
        config: {
      ...
      providers: [_services_auth_service__WEBPACK_IMPORTED_MODULE_13__["AuthService"], _services_error_interceptor__WEBPACK_IMPORTED_MODULE_15__["ErrorInterceptorProvider"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_22__["AuthGuard"], _guards_prevent_unsaved_changes_guard__WEBPACK_IMPORTED_MODULE_30__["PreventUnsavedChanges"], _services_alertify_service__WEBPACK_IMPORTED_MODULE_14__["AlertifyService"], _services_user_service__WEBPACK_IMPORTED_MODULE_23__["UserService"], _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_26__["MemberDetailResolver"], _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_27__["MemberListResolver"], _resolver_member_edit_resolver__WEBPACK_IMPORTED_MODULE_29__["MemberEditResolver"], {
      ...
      _createClass(HomeComponent, [{
        ...
        value: function login() {
          ...
          this.authService.login(this.model).subscribe(function (next) {
            _this12.alertify.success('Logged in Successfully');
          }, function (error) {
            _this12.alertify.error('Failed to Log in');
          }, function () {
  ...
  function srcAppNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function NavbarComponent(authService, alertify, router) {
      ...
      _createClass(NavbarComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.authService.currentPhotoUrl.subscribe(function (photoUrl) {
            return _this16.photoUrl = photoUrl;
          });
        }
      }, {
        key: "login",
        value: function login() {
          ...
          this.authService.login(this.model).subscribe(function (next) {
            _this17.alertify.success('Logged in Successfully');
          }, function (error) {
            _this17.alertify.error('Failed to Log in');
          }, function () {
            _this17.router.navigate(['/discover']);
          });
        }
      }, {
        key: "loggedIn",
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function RegisterComponent(authService, router, alertify, fb) {
        ...
        this.router = router;
        this.alertify = alertify;
        this.fb = fb; // Component communication child to parent
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function signup() {
          ...
          if (this.registerForm.valid) {
            ...
            this.authService.signup(this.user).subscribe(function () {
              _this18.alertify.success('Registration Successful');
            }, function (error) {
              _this18.alertify.error(error);
            }, function () {
              _this18.authService.login(_this18.user).subscribe(function () {
                _this18.router.navigate(['/discover']);
              });
            });
          }
        }
  ...
  function srcAppRoutesTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./_resolver/member-detail-resolver */
    "./src/app/_resolver/member-detail-resolver.ts");
    /* harmony import */


    var _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./_resolver/member-list-resolver */
    "./src/app/_resolver/member-list-resolver.ts");
    /* harmony import */
    ...
    var _resolver_member_edit_resolver__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./_resolver/member-edit-resolver */
    "./src/app/_resolver/member-edit-resolver.ts");
    /* harmony import */
    ...
    var appRoutes = [{
      ...
      children: [{
        ...
        resolve: {
          users: _resolver_member_list_resolver__WEBPACK_IMPORTED_MODULE_8__["MemberListResolver"]
        }
      }, {
        path: 'discover/:id',
        component: _Members_member_detail_member_detail_component__WEBPACK_IMPORTED_MODULE_6__["MemberDetailComponent"],
        resolve: {
          user: _resolver_member_detail_resolver__WEBPACK_IMPORTED_MODULE_7__["MemberDetailResolver"]
        }
      }, {
        path: 'member/edit',
        component: _members_member_edit_member_edit_component__WEBPACK_IMPORTED_MODULE_9__["MemberEditComponent"],
        resolve: {
          user: _resolver_member_edit_resolver__WEBPACK_IMPORTED_MODULE_10__["MemberEditResolver"]
        },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\Senthilkumar\Documents\GitHub\Dating-App\DatingApp-SPA\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
